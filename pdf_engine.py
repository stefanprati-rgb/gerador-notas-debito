...
<head>
    ...
    <style>
        ...
        body { font-family: Helvetica, Arial, sans-serif; font-size: 9pt; color: #000; line-height: 1.2; }
        table { width: 100%; border-collapse: collapse; table-layout: fixed; }
        td { vertical-align: top; padding: 4px; word-wrap: break-word; }
        .header-title { font-size: 14pt; font-weight: bold; text-transform: uppercase; text-align: right; margin-bottom: 10px; }
        .label { font-size: 7pt; font-weight: bold; text-transform: uppercase; color: #444; display: block; }
        .value { font-size: 9pt; font-weight: bold; color: #000; display: block; margin-bottom: 5px; }
        .main-box { border: 1px solid #000; margin-top: 5px; margin-bottom: 15px; }
        .items-header th { border-top: 1px solid #000; border-bottom: 1px solid #000; text-align: left; padding: 4px; font-size: 8pt; background-color: #f2f2f2; }
        .item-row td { padding-top: 8px; padding-bottom: 8px; border-bottom: 1px solid #eee; }
        .total-row td { border-top: 2px solid #000; border-bottom: 1px solid #000; font-weight: bold; background-color: #f2f2f2; padding: 6px; font-size: 10pt; }
